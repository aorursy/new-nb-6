...
ftrain_df = generate_feature_vector(train_df.sample(800))
...
auto_classifier = TPOTClassifier(generations=1, population_size=5, verbosity=1)
...
guess_df.sample(3)
guess_df.to_csv('guess800.csv', index = False)