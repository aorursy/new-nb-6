...
dnn_reg_solo = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_solo = tf.contrib.learn.SKCompat(dnn_reg_solo) # to be compatible with sklearn
dnn_reg_solo.fit(x_train_solo_scaled, y_true_solo, batch_size=50, steps=5000)
# analysing duo
...
dnn_reg_duo = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_duo = tf.contrib.learn.SKCompat(dnn_reg_duo) # to be compatible with sklearn
dnn_reg_duo.fit(x_train_duo_scaled, y_true_duo, batch_size=50, steps=5000)
# Analysing squad
...
dnn_reg_squad = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_squad = tf.contrib.learn.SKCompat(dnn_reg_squad) # to be compatible with sklearn
dnn_reg_squad.fit(x_train_squad_scaled, y_true_squad, batch_size=50, steps=5000)
# Analysing solo-fpp
...
dnn_reg_solo_fpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_solo_fpp = tf.contrib.learn.SKCompat(dnn_reg_solo_fpp) # to be compatible with sklearn
dnn_reg_solo_fpp.fit(x_train_solo_fpp_scaled, y_true_solo_fpp, batch_size=50, steps=5000)
# Analysing duo-fpp
...
dnn_reg_duo_fpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_duo_fpp = tf.contrib.learn.SKCompat(dnn_reg_duo_fpp) # to be compatible with sklearn
dnn_reg_duo_fpp.fit(x_train_duo_fpp_scaled, y_true_duo_fpp, batch_size=50, steps=5000)
# Analysing squad-fpp
...
dnn_reg_squad_fpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_squad_fpp = tf.contrib.learn.SKCompat(dnn_reg_squad_fpp) # to be compatible with sklearn
dnn_reg_squad_fpp.fit(x_train_squad_fpp_scaled, y_true_squad_fpp, batch_size=50, steps=5000)
# Analysing flarefpp
...
dnn_reg_flarefpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_flarefpp = tf.contrib.learn.SKCompat(dnn_reg_flarefpp) # to be compatible with sklearn
dnn_reg_flarefpp.fit(x_train_flarefpp_scaled, y_true_flarefpp, batch_size=50, steps=5000)
# Analysing flaretpp
...
dnn_reg_flaretpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_flaretpp = tf.contrib.learn.SKCompat(dnn_reg_flaretpp) # to be compatible with sklearn
dnn_reg_flaretpp.fit(x_train_flaretpp_scaled, y_true_flaretpp, batch_size=50, steps=5000)
# Analysing crashfpp
...
dnn_reg_crashfpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_crashfpp = tf.contrib.learn.SKCompat(dnn_reg_crashfpp) # to be compatible with sklearn
dnn_reg_crashfpp.fit(x_train_crashfpp_scaled, y_true_crashfpp, batch_size=50, steps=5000)
# Analysing crashtpp
...
dnn_reg_crashtpp = tf.contrib.learn.DNNRegressor(hidden_units=[500,500], activation_fn = tf.nn.relu, feature_columns=feature_columns, config=config)
dnn_reg_crashtpp = tf.contrib.learn.SKCompat(dnn_reg_crashtpp) # to be compatible with sklearn
dnn_reg_crashtpp.fit(x_train_crashtpp_scaled, y_true_crashtpp, batch_size=50, steps=5000)
