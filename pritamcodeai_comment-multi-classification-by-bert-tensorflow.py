...
shutil.os.mkdir(os.getcwd() + "download_data")
os.chdir(os.getcwd() + "download_data")
# download from web
...
if (os.path.exists('uncased_L-12_H-768_A-12.zip') == True):
    ...
    with ZipFile('uncased_L-12_H-768_A-12.zip', 'r') as zip: 
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    return model_fn
shutil.os.mkdir(os.getcwd() + "output")

OUTPUT_DIR = '/kaggle/workingdownload_datadownload_dataoutput'
