...
daily_online_revenue['d-1_rev'] = daily_online_revenue['Revenue'].shift(1)
...
daily_online_revenue = daily_online_revenue.dropna()
...
train_data = daily_online_revenue.loc[:'2017-11-30']

test_data = daily_online_revenue.loc['2017-12-1':]
train_data
# Pisahkan kolom yang ingin diprediksi (biasa disebut label menjadi y), dan variabel lain menjadi x

x_train = train_data.drop('Revenue', 1)
