...
# !python submission.py --weights ../input/yolov5-for-wheat/yolov5_for_test/weights/best_load_yolov5x_pt.pt --source ../input/global-wheat-detection/test --img 1024 --conf 0.4 --iou 0.65 --augment --save
...
class opt:
    ...
    weights = "../input/yolov5-for-wheat/yolov5_for_test/weights/best_load_yolov5x_pt.pt"
