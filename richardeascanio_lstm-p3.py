...
# Dividimos el dataset de entrenamiento a train y val
...
embed_size = 300 # Tamaño de cada vector de palabras

max_features = 50000 # Cuantas palabras unicas usamos

maxlen = 100 # Numero maximo de palabras 



# Llenamos los datos faltantes con "na"
...
# Tokenizamos las oraciones y las convertimos a vectores de sequencias
...
## Obtenemos el valor del 'target'

train_y = train_df['target'].values

val_y = val_df['target'].values
# Hacemos shuffle de la data
