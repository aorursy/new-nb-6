...
net = load_net('../input/gwdmodels/cp_effdet39.pth')
    ...
    with torch.no_grad():
        ...
        for tta_transform in tta_transforms:
            ...
            det = net(tta_transform.batch_augment(images.clone()),
                      ...
                      torch.tensor([1.0]*images.shape[0]).float().cuda())
...
def run_wbf(predictions, image_index, image_size=512, iou_thr=0.55, skip_box_thr=0.38, weights=None):
