...
IMAGE_SIZE = [331, 331] # The Main Use of TPU Less memory usage so feel free to se the largest
...
with strategy.scope():
    ...
    pretrained_model = tf.keras.applications.nasnet.NASNetLarge(input_shape=None, include_top=False, weights='imagenet')
