...
convertTrainLabel()
## train YoloV5 to obtain pre-trained model best.pt (1 epochs takes 15mins with GPU)
#!python train.py --img 1024 --batch 4 --epochs 10 --data ../input/configyolo5/wheat0.yaml --cfg models/yolov5x.yaml --weight ""
