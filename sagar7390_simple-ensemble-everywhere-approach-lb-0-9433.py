...
df_train['sex'] = df_train['sex'].astype("category").cat.codes +1
...
df_test.head()
x_train = df_train[['sex', 'age_approx','anatom_site_general_challenge']]
y_train = df_train['target']

x_test = df_test[['sex', 'age_approx','anatom_site_general_challenge']]
...
final_target =  submission * 0.9 + 0.1*xgb_df
result = pd.DataFrame({
