...
print(score)
history = model1.fit(X_train, Y_train, batch_size=128, epochs=15, verbose=1, validation_data=(X_test1, y_test1))

model1.save_weights('/kaggle/working/save_model_lstm_with_conv.h5')
