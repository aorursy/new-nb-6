...
training_data_original = pd.read_csv('/kaggle/input/inputs3/train.csv')
...
state_metadata = pd.read_excel('/kaggle/input/externaldata3/states.xlsx')

country_metadata = pd.read_excel('/kaggle/input/externaldata3/countries.xlsx')
country_metadata.tail()
...
test_data = pd.read_csv('/kaggle/input/inputs3/test.csv')
...
excl_list = ['Belize', 'Botswana', 'Diamond Princess', 'MS Zaandam', 'Angola',
            ...
            'Nicaragua', 'Sudan']
predictions = generate_prediction(test_data, training_data, countries_main, countries, states, min_num_cases = 100)
...
prediction_final[prediction_final['Country_Region'] == 'Germany']
