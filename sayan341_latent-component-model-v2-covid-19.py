...
training_data_original = pd.read_csv('/kaggle/input/inputs-data/train_data.csv')
...
state_metadata = pd.read_excel('/kaggle/input/external-data-source/states_data.xlsx')
country_metadata = pd.read_excel('/kaggle/input/external-data-source/countries_data.xlsx')
...
def generate_prediction(test_data, training_data, countries_main, countries, states, min_num_cases):
    ...
    return test_data
test_data = pd.read_csv('/kaggle/input/inputs-data/test_data.csv')
...
predictions = generate_prediction(test_data, training_data, countries_main, countries, states, min_num_cases = 10)
